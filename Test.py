...
class CourseBox(tk.Frame):
    def __init__( 
        ...
        self.like_count_label.place(x=x_like_count_label, y=40) ##Specify x possition of like counter label
        ...
        self.dislike_count_label.place(x=x_dislike_count_label, y=41) #Specify y possition of dislike counter label
